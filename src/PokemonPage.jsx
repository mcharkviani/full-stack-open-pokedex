      ...
      <div className={`pokemon-page pokemon-type-${type.name}`}>
        ...
        <div className="pokemon-info">
          ...
          <div className="pokemon-abilities">
            {normalAbility && <PokemonAbility state='Normal' abilityName={formatName(normalAbility.ability.name)} />}
            {hiddenAbility && <PokemonAbility state='Hidden' abilityName={formatName(hiddenAbility.ability.name)} />}
          </div>
        </div>
      </div>
    </>
